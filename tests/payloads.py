        ...
        "sections": {
            ...
            "openings": {
                ...
                "concentration": {
                    ...
                    "target": 0.6,
                    "segments": [
                        {"name": "Vienna Game", "color": "white", "games": 96, "share": 0.2689},
                        {
                            "name": "Sicilian Defense",
                            "color": "black",
                            "games": 71,
                        ...
                        {"name": None, "color": None, "games": 190, "share": 0.5322},
                    ],
                    "covering": {"systems": 2, "share": 0.4678, "reached": False},
                },
                "tree": {
                    "plies": 8,
                    "min_games": 2,
...
def sparse_payload() -> dict[str, Any]:
    ...
    sections["openings"] |= {
        ...
        "concentration": {
            "games": 6,
            "target": 0.6,
            "segments": [{"name": None, "color": None, "games": 6, "share": 1.0}],
            "covering": {"systems": 0, "share": 0.0, "reached": False},
        },
